...
const COLUMN_DEFS = [
  ...
  { id: "com_anders", key: "com_anders", label: "Communicatie – Anders" },
  ...
  { id: "inst_anders", key: "inst_anders", label: "Instrumenten – Anders" },
...
function rowsForEntry(e) {
  const base = {
    ...
    com_werkmobiel: e.com_werkmobiel ?? "", com_charger: e.com_charger ?? "", com_anders: e.com_anders ?? "",
    inst_conventioneel: e.inst_conventioneel ?? "", inst_aws: e.inst_aws ?? "", inst_awos: e.inst_awos ?? "",
    inst_pc_lhb: e.inst_pc_lhb ?? "", inst_radar: e.inst_radar ?? "", inst_anders: e.inst_anders ?? "",
